...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-lg font-bold text-gray-900">New Appointment</h2>
            <p class="text-sm text-gray-500">Schedule a patient visit</p>
        </div>
    </div>

    {{-- Form --}}
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <form method="POST" action="{{ route('appointments.store') }}" class="space-y-0">
            @csrf
            ...
            <div class="px-6 py-5 space-y-4 border-b border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="appointment_date" class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1.5">Start Time <span class="text-red-500">*</span></label>
                        <input type="time" name="start_time" class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-5 space-y-4 border-b border-gray-100">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3" placeholder="Additional notes about this appointment..." class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"></textarea>
                </div>
            </div>
