...
function openStepperModal(visitId, patientName, status) {
    ...
    const steps = [
        ...
        { name: 'Payment', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', completed: status.includes('waiting_for_doctor') || status.includes('with') || status.includes('lab') || status.includes('pharmacy') || status.includes('completed') },
        { name: 'Waiting for Doctor', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', completed: status.includes('waiting_for_doctor') || status.includes('with') || status.includes('lab') || status.includes('pharmacy') || status.includes('completed') },
        { name: 'With Doctor', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', completed: status.includes('with') || status.includes('lab') || status.includes('pharmacy') || status.includes('completed') },
        { name: 'Lab Tests', icon: 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z', completed: status.includes('lab') || status.includes('pharmacy') || status.includes('completed') },
        { name: 'Pharmacy', icon: 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z', completed: status.includes('pharmacy') || status.includes('completed') },
