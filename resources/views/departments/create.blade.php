...
@section('title', 'Add Department - ' . config('app.name', 'Laravel'))
...
<div class="max-w-xl mx-auto bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
    <form method="POST" action="{{ route('departments.store') }}" class="space-y-4">
        ...
        <div class="pt-4">
            <button type="submit" class="bg-emerald-600 text-white text-sm font-medium px-5 py-2 rounded-lg hover:bg-emerald-700">Save Department</button>
        </div>
    </form>
</div>
@endsection
